    ...
    var t = {
                    ...
                    l = function(t) {
                        function e(e, n) {
                            var i = t.call(this, e, n) || this,
                                ...
                                r = s ? JSON.parse(s) : {},
                                l = o(o({}, r), n);
                            return i.currentIndex = (null == l ? void 0 : l.currentIndex) || 1, i.mode = (null == l ? void 0 : l.mode) || "linear", i.isCompleted = void 0 !== (null == l ? void 0 : l.isCompleted) && (null == l ? void 0 : l.isCompleted), i.totalSteps = 1, i.navItems = [], i.contentItems = [], i.init(), i
                        }
                        return s(e, t), e.prototype.init = function() {
                            ...
                            var e = this,
                                ...
                                i = t.isDisabled,
                                s = t.el;
                            n === this.currentIndex && this.setCurrentNavItem(), ("linear" !== this.mode || i) && s.addEventListener("click", (function() {
                            ...
                            var e = JSON.parse(t.getAttribute("data-hs-stepper-nav-item")),
                                ...
                                f = e.hasError,
                                v = void 0 !== f && f;
                            r && t.classList.add("success"), p && t.classList.add("skipped"), h && ("BUTTON" !== t.tagName && "INPUT" !== t.tagName || t.setAttribute("disabled", "disabled"), t.classList.add("disabled")), v && t.classList.add("error"), this.navItems.push({
                                index: n,
                                isFinal: s,
                                isCompleted: r,
                                isSkip: p,
                            ...
                            t.classList.add("active"), this.fireEvent("active", this.currentIndex), (0, r.dispatch)("active.hs.stepper", this.el, this.currentIndex)
                            ...
                            var e = JSON.parse(t.getAttribute("data-hs-stepper-content-item")),
                                ...
                                l = e.isSkip,
                                p = void 0 !== l && l;
                            r && t.classList.add("success"), p && t.classList.add("skipped"), this.contentItems.push({
                                index: n,
                                isFinal: s,
                                isCompleted: r,
                                isSkip: p,
                            ...
                            this.nextBtn && this.nextBtn.addEventListener("click", (function() {
                                var e;
                                if (t.fireEvent("beforeNext", t.currentIndex), (0, r.dispatch)("beforeNext.hs.stepper", t.el, t.currentIndex), null === (e = t.getNavItem(t.currentIndex)) || void 0 === e ? void 0 : e.isProcessed) return t.disableAll(), !1;
                                t.goToNext()
                            }))
                            ...
                            n && i && (this.setSkipItemActions(n), this.setSkipItemActions(i))
                            ...
                            this.setSkipItem(), this.handleNextButtonClick(), this.fireEvent("skip", this.currentIndex), (0, r.dispatch)("skip.hs.stepper", this.el, this.currentIndex)
                            ...
                            n && i && (this.setCompleteItemActions(n), this.setCompleteItemActions(i))
                            ...
                            this.setCompleteItem(), this.fireEvent("complete", this.currentIndex), (0, r.dispatch)("complete.hs.stepper", this.el, this.currentIndex), this.handleNextButtonClick(!1), this.showFinishButton(), this.showCompleteStepButton(), this.checkForTheFirstStep(), this.completeStepBtn && this.changeTextAndDisableCompleteButtonIfStepCompleted(), this.showSkipButton()
                            ...
                            (s ? s.el : null).classList.remove("active"), i.style.display = "block", this.backBtn && (this.backBtn.style.display = "none"), this.nextBtn && (this.nextBtn.style.display = "none"), this.skipBtn && (this.skipBtn.style.display = "none"), this.completeStepBtn && (this.completeStepBtn.style.display = "none"), this.finishBtn && (this.finishBtn.style.display = "none"), this.resetBtn && (this.resetBtn.style.display = ""), n.length <= 1 && (this.isCompleted = !0, this.setCompleted()), this.fireEvent("finish", this.currentIndex), (0, r.dispatch)("finish.hs.stepper", this.el, this.currentIndex)
                            ...
                            })), this.currentIndex = 1, this.setCurrentNavItem(), this.setCurrentContentItem(), this.showFinishButton(), this.showCompleteStepButton(), this.checkForTheFirstStep(), this.unsetCompleted(), this.isCompleted = !1, this.fireEvent("reset", this.currentIndex), (0, r.dispatch)("reset.hs.stepper", this.el, this.currentIndex)
            ...
            969: function(t, e) {
                ...
                e.isEnoughSpace = function(t, e, n, i, s) {
                    void 0 === n && (n = "auto"), void 0 === i && (i = 10), void 0 === s && (s = null);
                    var o = e.getBoundingClientRect(),
                        r = s ? s.getBoundingClientRect() : null,
                        l = window.innerHeight,
                        p = r ? o.top - r.top : o.top,
                        a = (s ? r.bottom : l) - o.bottom,
                        c = t.clientHeight + i;
                    return "bottom" === n ? a >= c : "top" === n ? p >= c : p >= c || a >= c
                };
