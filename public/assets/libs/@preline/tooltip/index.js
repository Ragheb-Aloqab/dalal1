    ...
    var e = {
            492: (e, t, n) => {
                    ...
                    fn: function(e) {
                        ...
                        Object.keys(t.elements).forEach((function(e) {
                            var n = t.styles[e] || {},
                                o = t.attributes[e] || {},
                                r = t.elements[e];
                            I(r) && P(r) && (Object.assign(r.style, n), Object.keys(o).forEach((function(e) {
                                var t = o[e];
                        ...
                        return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow),
                            function() {
                                Object.keys(t.elements).forEach((function(e) {
                                    ...
                                    I(o) && P(o) && (Object.assign(o.style, i), Object.keys(r).forEach((function(e) {
                                        o.removeAttribute(e)
                                    })))
                                }))
                            }
                ...
                function W(e, t, n) {
                    ...
                    var o = e.getBoundingClientRect(),
                        r = 1,
                        i = 1;
                    t && I(e) && (r = e.offsetWidth > 0 && H(o.width) / e.offsetWidth || 1, i = e.offsetHeight > 0 && H(o.height) / e.offsetHeight || 1);
                    var a = (C(e) ? A(e) : window).visualViewport,
                        s = !R() && n,
                ...
                function U(e) {
                    return "html" === P(e) ? e : e.assignedSlot || e.parentNode || (_(e) ? e.host : null) || K(e)
                }
                ...
                function F(e) {
                    for (var t = A(e), n = $(e); n && N(n) && "static" === V(n).position;) n = $(n);
                    return n && ("html" === P(n) || "body" === P(n) && "static" === V(n).position) ? t : n || function(e) {
                        var t = /firefox/i.test(k());
                        if (/Trident/i.test(k()) && I(e) && "fixed" === V(e).position) return null;
                        var n = U(e);
                        for (_(n) && (n = n.host); I(n) && ["html", "body"].indexOf(P(n)) < 0;) {
                            var o = V(n);
                ...
                const Q = {
                    ...
                    fn: function(e) {
                        var t, n = e.state,
                            ...
                            u = M(n.placement),
                            d = X(u),
                            h = [a, i].indexOf(u) >= 0 ? "height" : "width";
                        if (l && p) {
                            var m = function(e, t) {
                                ...
                                g = "y" === d ? o : a,
                                y = "y" === d ? r : i,
                                b = n.rects.reference[h] + n.rects.reference[d] - p[d] - n.rects.popper[h],
                                w = p[d] - n.rects.reference[d],
                                x = F(l),
                                ...
                                P = z(S, L, T),
                                A = d;
                            n.modifiersData[s] = ((t = {})[A] = P, t.centerOffset = P - L, t)
                        }
                    },
                    effect: function(e) {
                        var t = e.state,
                ...
                function te(e) {
                    ...
                    if (h) {
                        var P = F(n),
                            C = "clientHeight",
                            I = "clientWidth";
                        if (P === A(n) && "static" !== V(P = K(n)).position && "absolute" === u && (C = "scrollHeight", I = "scrollWidth"), f === o || (f === a || f === i) && c === l) T = r, w -= (v && P === L && L.visualViewport ? L.visualViewport.height : P[C]) - s.height, w *= d ? 1 : -1;
                        if (f === a || (f === o || f === r) && c === l) S = i, y -= (v && P === L && L.visualViewport ? L.visualViewport.width : P[I]) - s.width, y *= d ? 1 : -1
                    }
                    ...
                    return y = M.x, w = M.y, d ? Object.assign({}, j, ((_ = {})[T] = E ? "0" : "", _[S] = O ? "0" : "", _.transform = (L.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + w + "px)" : "translate3d(" + y + "px, " + w + "px, 0)", _)) : Object.assign({}, j, ((t = {})[T] = E ? w + "px" : "", t[S] = O ? y + "px" : "", t.transform = "", t))
                }
                const ne = {
                    name: "computeStyles",
                    enabled: !0,
                ...
                const re = {
                    ...
                    effect: function(e) {
                        ...
                        return i && c.forEach((function(e) {
                            ...
                            })), s && f.addEventListener("resize", n.update, oe),
                            function() {
                                i && c.forEach((function(e) {
                                    e.removeEventListener("scroll", n.update, oe)
                                })), s && f.removeEventListener("resize", n.update, oe)
                            }
                    },
                    data: {}
                };
                ...
                function ue(e) {
                    return ["html", "body", "#document"].indexOf(P(e)) >= 0 ? e.ownerDocument.body : I(e) && pe(e) ? e : ue(U(e))
                }
                ...
                function de(e, t) {
                    ...
                    var o = ue(e),
                        ...
                        i = A(o),
                        a = r ? [i].concat(i.visualViewport || [], pe(o) ? o : []) : o,
                        s = t.concat(a);
                    return r ? s : s.concat(de(U(a)))
                }
                ...
                function me(e, t, n) {
                    return t === u ? he(function(e, t) {
                        ...
                        var t, n = K(e),
                            ...
                            s = -o.scrollLeft + le(e),
                            f = -o.scrollTop;
                        return "rtl" === V(r || n).direction && (s += D(n.clientWidth, r ? r.clientWidth : 0) - i), {
                            width: i,
                            height: a,
                            x: s,
                            y: f
                ...
                function ve(e, t, n, o) {
                    var r = "clippingParents" === t ? function(e) {
                            var t = de(U(e)),
                                n = ["absolute", "fixed"].indexOf(V(e).position) >= 0 && I(e) ? F(e) : e;
                            return C(n) ? t.filter((function(e) {
                                return C(e) && q(e, n) && "body" !== P(e)
                            })) : []
                        }(e) : [].concat(t),
                        i = [].concat(r, [n]),
                        a = i[0],
                        s = i.reduce((function(t, n) {
                            var r = me(e, n, o);
                            return t.top = D(r.top, t.top), t.right = B(r.right, t.right), t.bottom = B(r.bottom, t.bottom), t.left = D(r.left, t.left), t
                        }), me(e, a, o));
                ...
                function ye(e, t) {
                    ...
                    var n = t,
                        ...
                        E = n.padding,
                        S = void 0 === E ? 0 : E,
                        T = G("number" != typeof S ? S : J(S, f)),
                        L = w === d ? h : d,
                        P = e.rects.popper,
                        A = e.elements[O ? L : w],
                        I = ve(C(A) ? A : A.contextElement || K(e.elements.popper), v, y, l),
                        _ = W(e.elements.reference),
                        j = ge({
                            reference: _,
                            element: P,
                            strategy: "absolute",
                ...
                const be = {
                    ...
                    fn: function(e) {
                        ...
                        if (!t.modifiersData[l]._skip) {
                            for (var p = n.mainAxis, u = void 0 === p || p, d = n.altAxis, h = void 0 === d || d, g = n.fallbackPlacements, y = n.padding, b = n.boundary, w = n.rootBoundary, x = n.altBoundary, O = n.flipVariations, E = void 0 === O || O, S = n.allowedAutoPlacements, T = t.options.placement, L = M(T), P = g || (L === T || !E ? [ae(T)] : function(e) {
                                    if (M(e) === s) return [];
                                    var t = ae(e);
                                    return [fe(e), t, fe(t)]
                                }(T)), A = [T].concat(P).reduce((function(e, n) {
                                    return e.concat(M(n) === s ? function(e, t) {
                                        void 0 === t && (t = {});
                                        var n = t,
                                            o = n.placement,
                                            r = n.boundary,
                                ...
                                }), []), C = t.rects.reference, I = t.rects.popper, _ = new Map, j = !0, D = A[0], B = 0; B < A.length; B++) {
                                var H = A[B],
                                    k = M(H),
                                    R = Z(H) === c,
                                    W = [o, r].indexOf(k) >= 0,
                                ...
                                var N = ae(V),
                                    K = [];
                                if (u && K.push(q[k] <= 0), h && K.push(q[V] <= 0, q[N] <= 0), K.every((function(e) {
                                        return e
                                    }))) {
                                    D = H, j = !1;
                                    break
                ...
                function xe(e) {
                    return [o, i, r, a].some((function(t) {
                        return e[t] >= 0
                    }))
                }
                const Oe = {
                        ...
                        var t = e.state,
                            ...
                            c = v.reduce((function(e, n) {
                                return e[n] = function(e, t, n) {
                                    var r = M(e),
                                        s = [a, o].indexOf(r) >= 0 ? -1 : 1,
                                        f = "function" == typeof n ? n(Object.assign({}, t, {
                                            placement: e
                                        })) : n,
                                        c = f[0],
                                        l = f[1];
                                    return c = c || 0, l = (l || 0) * s, [a, i].indexOf(r) >= 0 ? {
                                        x: l,
                                        y: c
                                    } : {
                                        x: c,
                            ...
                            p = l.x,
                            u = l.y;
                        null != t.modifiersData.popperOffsets && (t.modifiersData.popperOffsets.x += p, t.modifiersData.popperOffsets.y += u), t.modifiersData[r] = c
                    }
                };
                const Se = {
                    name: "popperOffsets",
                        ...
                        if (P) {
                            if (l) {
                                var k, R = "y" === T ? o : a,
                                    ...
                                    ne = ee[W],
                                    oe = z(0, A[q], Q[q]),
                                    re = S ? A[q] / 2 - U - oe - te - _.mainAxis : $ - oe - te - _.mainAxis,
                                    ie = S ? -A[q] / 2 + U + oe + ne + _.mainAxis : G + oe + ne + _.mainAxis,
                                    ae = t.elements.arrow && F(t.elements.arrow),
                                    se = ae ? "y" === T ? ae.clientTop || 0 : ae.clientLeft || 0 : 0,
                                    fe = null != (k = null == j ? void 0 : j[T]) ? k : 0,
                                    ce = V + ie - fe,
                                    le = z(y ? B(N, V + re - fe - se) : N, V, y ? D(K, ce) : K);
                                P[T] = le, H[T] = le - V
                            }
                            if (u) {
                                var pe, ue = "x" === T ? o : a,
                                    ...
                                    ge = he - x[de],
                                    be = -1 !== [o, a].indexOf(O),
                                    we = null != (pe = null == j ? void 0 : j[L]) ? pe : 0,
                                    xe = be ? ve : he - A[me] - C[me] - we + _.altAxis,
                                    Oe = be ? he + A[me] + C[me] - we - _.altAxis : ge,
                                    Ee = y && be ? function(e, t, n) {
                                        var o = z(e, t, n);
                                        return o > n ? n : o
                                    }(xe, he, Oe) : z(y ? xe : ve, he, y ? Oe : ge);
                                P[L] = Ee, H[L] = Ee - he
                            }
                            t.modifiersData[s] = H
                        }
                ...
                function Le(e, t, n) {
                    ...
                    return (i || !i && !n) && (("body" !== P(t) || pe(s)) && (c = (o = t) !== A(o) && I(o) ? {
                        scrollLeft: (r = o).scrollLeft,
                        scrollTop: r.scrollTop
                    } : ce(o)), I(t) ? ((l = W(t, !0)).x += t.clientLeft, l.y += t.clientTop) : s && (l.x = le(s))), {
                        ...
                        var r, a, s = {
                            ...
                            l = {
                                ...
                                setOptions: function(n) {
                                    ...
                                    p(), s.options = Object.assign({}, i, s.options, r), s.scrollParents = {
                                        reference: C(e) ? de(e) : e.contextElement ? de(e.contextElement) : [],
                                        popper: de(t)
                                    };
                                ...
                                forceUpdate: function() {
                                    if (!c) {
                                        ...
                                        if (Ce(t, n)) {
                                            s.rects = {
                                                reference: Le(t, F(n), "fixed" === s.options.strategy),
                                                popper: Y(n)
                ...
                var _e = Ie(),
                    je = Ie({
                        defaultModifiers: [re, Se, ne, j, Ee, be, Te, Q, Oe]
                    }),
                    Me = Ie({
                        defaultModifiers: [re, Se, ne, j]
                    })
            },
            190: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.COMBO_BOX_ACCESSIBILITY_KEY_SET = t.SELECT_ACCESSIBILITY_KEY_SET = t.TABS_ACCESSIBILITY_KEY_SET = t.OVERLAY_ACCESSIBILITY_KEY_SET = t.DROPDOWN_ACCESSIBILITY_KEY_SET = t.POSITIONS = void 0, t.POSITIONS = {
                    auto: "auto",
                    ...
                    "left-end": "left-end"
                }, t.DROPDOWN_ACCESSIBILITY_KEY_SET = ["Escape", "ArrowUp", "ArrowDown", "Home", "End", "Enter"], t.OVERLAY_ACCESSIBILITY_KEY_SET = ["Escape", "Tab"], t.TABS_ACCESSIBILITY_KEY_SET = ["ArrowUp", "ArrowLeft", "ArrowDown", "ArrowRight", "Home", "End"], t.SELECT_ACCESSIBILITY_KEY_SET = ["ArrowUp", "ArrowLeft", "ArrowDown", "ArrowRight", "Home", "End", "Escape", "Enter", "Tab"], t.COMBO_BOX_ACCESSIBILITY_KEY_SET = ["ArrowUp", "ArrowLeft", "ArrowDown", "ArrowRight", "Home", "End", "Escape", "Enter"]
            },
            737: (e, t) => {
                /*
                 * HSBasePlugin
                ...
                var n = function() {
                    function e(e, t, n) {
                        this.el = e, this.options = t, this.events = n, this.el = e, this.options = t, this.events = {}
                    }
                    return e.prototype.createCollection = function(e, t) {
                        var n;
                        e.push({
            ...
            679: function(e, t, n) {
                ...
                var s = n(492),
                    ...
                    p = function(e) {
                        function t(t, n, o) {
                            ...
                            return r.el && (r.toggle = r.el.querySelector(".hs-tooltip-toggle") || r.el, r.content = r.el.querySelector(".hs-tooltip-content"), r.eventMode = (0, f.getClassProperty)(r.el, "--trigger") || "hover", r.preventPopper = (0, f.getClassProperty)(r.el, "--prevent-popper", "false"), r.placement = (0, f.getClassProperty)(r.el, "--placement"), r.strategy = (0, f.getClassProperty)(r.el, "--strategy")), r.el && r.toggle && r.content && r.init(), r
                        }
                        return r(t, e), t.prototype.init = function() {
                            ...
                            var t = function() {
                                setTimeout((function() {
                                    e.hide(), e.toggle.removeEventListener("click", t, !0), e.toggle.removeEventListener("blur", t, !0)
                                }))
                            };
                            this.toggle.addEventListener("click", t, !0), this.toggle.addEventListener("blur", t, !0)
                            ...
                            this.popperInstance = (0, s.createPopper)(this.toggle, this.content, {
                                placement: l.POSITIONS[this.placement] || "top",
                            ...
                            var e = this;
                            this.content.classList.remove("hidden"), "false" === this.preventPopper && (this.popperInstance.setOptions((function(e) {
                                return i(i({}, e), {
                                    modifiers: a(a([], e.modifiers, !0), [{
                                        name: "eventListeners",
                                        enabled: !0
                                    }], !1)
                                })
                            })), this.popperInstance.update()), setTimeout((function() {
                                e.el.classList.add("show"), e.fireEvent("show", e.el), (0, f.dispatch)("show.hs.tooltip", e.el, e.el)
                            }))
                        }, t.prototype.hide = function() {
                            var e = this;
                            this.el.classList.remove("show"), "false" === this.preventPopper && this.popperInstance.setOptions((function(e) {
                                return i(i({}, e), {
                                    modifiers: a(a([], e.modifiers, !0), [{
                                        name: "eventListeners",
                                        enabled: !1
                            ...
                            })), this.fireEvent("hide", this.el), (0, f.dispatch)("hide.hs.tooltip", this.el, this.el), (0, f.afterTransition)(this.content, (function() {
                            ...
                            window.$hsTooltipCollection || (window.$hsTooltipCollection = []), document.querySelectorAll(".hs-tooltip").forEach((function(e) {
                                window.$hsTooltipCollection.find((function(t) {
                                    var n;
                                    return (null === (n = null == t ? void 0 : t.element) || void 0 === n ? void 0 : n.el) === e
                                })) || new t(e)
                            }))
                        }, t.show = function(e) {
                            var t = window.$hsTooltipCollection.find((function(t) {
                                return t.element.el === ("string" == typeof e ? document.querySelector(e) : e)
                            }));
                            ...
                            var o = window.$hsTooltipCollection.find((function(e) {
                ...
                window.addEventListener("load", (function() {
                    p.autoInit()
                })), "undefined" != typeof window && (window.HSTooltip = p), t.default = p
            },
            969: function(e, t) {
                var n = this;
                Object.defineProperty(t, "__esModule", {
                ...
                t.isEnoughSpace = function(e, t, n, o, r) {
                    ...
                    var i = t.getBoundingClientRect(),
                        ...
                        f = a ? i.top - a.top : i.top,
                        c = (r ? a.bottom : s) - i.bottom,
                        l = e.clientHeight + o;
                    return "bottom" === n ? c >= l : "top" === n ? f >= l : f >= l || c >= l
                };
