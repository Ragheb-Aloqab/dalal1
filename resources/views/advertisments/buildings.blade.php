<x-app-layout>
    <x-container>
        <div class="container p-4 mx-auto">
            <h1 class="mb-4 text-2xl font-bold">Search Buildings</h1>

            <form action="{{ route('advertisements.buildings') }}" method="GET" class="space-y-4">
                <!-- Price Min -->
                ...
                <!-- Floors Number -->
                <div class="flex flex-col">
                    <label for="floors_number" class="font-semibold">Min Floors</label>
                    <input type="number" name="floors_number" id="floors_number" value="{{ request('floors_number') }}"
                        class="p-2 border rounded">
                </div>

                <!-- Apartments Count -->
                <div class="flex flex-col">
                    <label for="apartments_count" class="font-semibold">Min Apartments</label>
                    <input type="number" name="apartments_count" id="apartments_count"
                        value="{{ request('apartments_count') }}" class="p-2 border rounded">
                </div>
