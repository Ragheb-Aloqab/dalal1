...
<ul class="grid w-full gap-6 md:grid-cols-4"> <!-- Updated to md:grid-cols-4 for 4 options -->
    <li>
        <input type="radio" id="react-option" name="technology" value="react" class="hidden peer"
            required>
    ...
    <li>
        <input type="radio" id="vue-option" name="technology" value="vue" class="hidden peer">
        <label for="vue-option"
            ...
            <div class="block">
                ...
                <div class="w-full text-sm">Vue.js is a model–view front end JavaScript framework.</div>
            </div>
        </label>
    </li>
    <li>
        <input type="radio" id="angular-option" name="technology" value="angular" class="hidden peer">
    ...
    <li>
        <input type="radio" id="svelte-option" name="technology" value="svelte" class="hidden peer">
        <label for="svelte-option"
            class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div class="block">
                <svg class="mb-2 text-purple-600 w-7 h-7" fill="currentColor" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                    <path
                        d="M32 0C14.4 0 0 14.4 0 32s14.4 32 32 32 32-14.4 32-32S49.6 0 32 0zm0 58.6c-14.6 0-26.6-12-26.6-26.6S17.4 5.4 32 5.4 58.6 17.4 58.6 32 46.6 58.6 32 58.6zm-3.2-15.8l-6.4-6.4h6.4v-8h-6.4l6.4-6.4 6.4 6.4h-6.4v8h6.4l-6.4 6.4z" />
                </svg>
                <div class="w-full text-lg font-semibold">Svelte</div>
                <div class="w-full text-sm">A modern framework for building user interfaces.</div>
            </div>
        </label>
    </li>
</ul>
