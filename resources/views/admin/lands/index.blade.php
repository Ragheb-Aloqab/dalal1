<x-app-layout-admin>
    ...
    <x-admin.search-and-add searchUrl="{{ route('admin.lands.index') }}"
    createUrl="{{ route('admin.lands.create') }}" />
    <x-admin.table>
        <x-admin.table-head>
        ...
        <x-admin.table-body>
            @foreach ($reals as $real)
                <tr class="search-items">
                    ...
                    <x-admin.table-data>
                        <x-admin.table-action-buttons :viewUrl="route('admin.lands.show', $real->id)" :editUrl="route('admin.lands.edit', $real->id)" :deleteUrl="route('admin.lands.destroy', $real->id)" />
                    </x-admin.table-data>
                </tr>
            @endforeach
        </x-admin.table-body>
