<x-app-layout-provider>
    ...
    <x-admin.search-and-add searchUrl="{{ route('provider.advertisements.index') }}"
        createUrl="{{ route('provider.advertisements.create') }}" />
        ...
        <x-admin.table-body>
            @foreach ($advertisements as $ad)
                <tr class="search-items">
                    ...
                    <x-admin.table-data>
                        <x-admin.table-action-buttons :viewUrl="route('provider.advertisements.show', $ad->id)" :editUrl="route('provider.advertisements.edit', $ad->id)" :deleteUrl="route('provider.advertisements.destroy', $ad->id)" />
                    </x-admin.table-data>
                </tr>
            @endforeach
        </x-admin.table-body>
