<x-app-layout-provider>
    ...
    <x-admin.search-and-add searchUrl="{{ route('provider.apartments.index') }}"
        createUrl="{{ route('provider.apartments.create') }}" />
        ...
        <x-admin.table-body>
            @foreach ($reals as $real)
                <tr class="search-items">
                    ...
                    <x-admin.table-data>
                        <x-admin.table-action-buttons :viewUrl="route('provider.apartments.show', $real->id)" :editUrl="route('provider.apartments.edit', $real->id)" :deleteUrl="route('provider.apartments.destroy', $real->id)" />
                    </x-admin.table-data>
                </tr>
            @endforeach
        </x-admin.table-body>
