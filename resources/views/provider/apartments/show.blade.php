                ...
                <div class="col-span-12 ">
                    <div class="mt-3">
                        <div class="flex items-center my-1 text-sm text-gray-700">
                            <i class="ml-2 text-blue-500 ti ti-building-skyscraper"></i>
                            الطابق: 5
                        </div>
                        <div class="flex items-center my-1 text-sm text-gray-700">
                            <i class="ml-2 text-blue-500 ti ti-bed"></i>
                            الغرف: 3
                        </div>
                        <div class="flex items-center my-1 text-sm text-gray-700">
                            <i class="ml-2 text-blue-500 ti ti-bath"></i>
                            الحمامات: 2
                        </div>
                        <div class="flex items-center my-1 text-sm text-gray-700">
                            <i class="ml-2 text-blue-500 ti ti-kitchen-2"></i>
                            المطابخ: 1
                        </div>
                        <div class="flex items-center my-1 text-sm text-gray-700">
                            <i class="ml-2 text-green-500 ti ti-home-2"></i>
                            الحالة: جديدة
                        </div>
