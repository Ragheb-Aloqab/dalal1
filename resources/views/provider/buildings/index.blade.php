<x-app-layout-provider>
    ...
    <x-admin.search-and-add searchUrl="{{ route('provider.buildings.index') }}"
    createUrl="{{ route('provider.buildings.create') }}" />
    <x-admin.table>
        <x-admin.table-head>
        ...
        <x-admin.table-body>
            @foreach ($reals as $real)
                <tr class="search-items">
                    ...
                    <x-admin.table-data>
                        <x-admin.table-action-buttons :viewUrl="route('provider.buildings.show', $real->id)" :editUrl="route('provider.buildings.edit', $real->id)" :deleteUrl="route('provider.buildings.destroy', $real->id)" />
                    </x-admin.table-data>
                </tr>
            @endforeach
        </x-admin.table-body>
