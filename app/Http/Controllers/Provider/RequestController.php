...
class RequestController extends Controller
{
    ...
    {
        $users =  User::all();
        return view('provider.requests.create',compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('provider.requests.index')
    ...
    {
        $request = UserRequest::findOrFail($id);
        return view('provider.requests.edit', compact('request'));
    }
...
;
    ...
    {
        $userRequest = Response::findOrFail($id);
        $userRequest->delete();
        return redirect()->route('provider.requests.index')
