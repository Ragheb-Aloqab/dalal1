...
class ChattingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.chats.index')->with('success', 'Conversation started successfully.');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.chats.edit', compact('conversation'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.chats.index')->with('success', 'Conversation updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.chats.index')->with('success', 'Conversation deleted successfully.');
    }
    ...
    public function sendMessage(Request $request, string $conversationId)
    {
        ...
        return redirect()->route('admin.chats.show', $conversationId)->with('success', 'Message sent successfully.');
    }
}
