...
class LandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.lands.index', compact(var_name: 'reals'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.lands.create', compact('providers', 'features'));
    }
    ...
    public function show(string $id)
    {
        ...
        if (!$realEstate || !$realEstate->isLand()) {
            return redirect()->route('admin.error-page')->with('error', 'السجل غير موجود');

        } else {
            return view('admin.lands.show', compact(var_name: 'realEstate'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.lands.index')->with('success', 'تم تعديل الأرض بنجاح');
    }
